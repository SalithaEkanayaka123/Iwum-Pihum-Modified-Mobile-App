...
public class CustomButtonSettings3 extends BaseAdapter {
    private Context context;
    ArrayList<customButton1> list;
    TextView title1, title2;

    public CustomButtonSettings3(Context context, ArrayList<customButton1> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if(view == null){
            ...
            view = layoutInflater.inflate(R.layout.activity_custom_button_settings3 , null);

            title1 = (TextView) view.findViewById(R.id.settingstitle5);
            title2 = (TextView) view.findViewById(R.id.settingstitle6);
